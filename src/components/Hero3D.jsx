...
// Importing GLB and image assets directly
import laptopGLB from '/src/assets/Laptop.glb';
import laptopImage from '/src/assets/laptop-static.png';
      ...
      <div className="w-full flex justify-center items-center">
        {isMobile ? (
          ...
          <Canvas
            ...
            style={{ height: 340, width: 440, maxWidth: "95vw" }}
          >
